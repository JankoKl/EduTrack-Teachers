...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(25413238905325834345)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413239215408834345)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413239550149834345)
,p_page_template_id=>wwv_flow_imp.id(25413238905325834345)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413239806258834345)
,p_page_template_id=>wwv_flow_imp.id(25413238905325834345)
