...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(25413230339773834340)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413230603247834340)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413230913976834340)
,p_page_template_id=>wwv_flow_imp.id(25413230339773834340)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413231249722834340)
,p_page_template_id=>wwv_flow_imp.id(25413230339773834340)
