...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(25413209734467834330)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413210034407834330)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413210382394834331)
,p_page_template_id=>wwv_flow_imp.id(25413209734467834330)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413210665270834331)
,p_page_template_id=>wwv_flow_imp.id(25413209734467834330)
