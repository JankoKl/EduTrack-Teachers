...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413322138823834382)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413322441155834382)
,p_plug_template_id=>wwv_flow_imp.id(25413322138823834382)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413322759696834383)
,p_plug_template_id=>wwv_flow_imp.id(25413322138823834382)
,p_name=>'Tabs'
