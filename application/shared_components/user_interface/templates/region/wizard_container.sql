...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413329890767834386)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413330135238834386)
,p_plug_template_id=>wwv_flow_imp.id(25413329890767834386)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413330456815834386)
,p_plug_template_id=>wwv_flow_imp.id(25413329890767834386)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413330783581834386)
,p_plug_template_id=>wwv_flow_imp.id(25413329890767834386)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413331034321834386)
,p_plug_template_id=>wwv_flow_imp.id(25413329890767834386)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413331378402834386)
,p_plug_template_id=>wwv_flow_imp.id(25413329890767834386)
