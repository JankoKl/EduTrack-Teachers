...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413274400914834362)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413274716326834362)
,p_plug_template_id=>wwv_flow_imp.id(25413274400914834362)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413275088346834362)
,p_plug_template_id=>wwv_flow_imp.id(25413274400914834362)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413275329255834362)
,p_plug_template_id=>wwv_flow_imp.id(25413274400914834362)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413275607879834362)
,p_plug_template_id=>wwv_flow_imp.id(25413274400914834362)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413275983457834362)
,p_plug_template_id=>wwv_flow_imp.id(25413274400914834362)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413276260028834363)
,p_plug_template_id=>wwv_flow_imp.id(25413274400914834362)
,p_name=>'Sub Regions'
