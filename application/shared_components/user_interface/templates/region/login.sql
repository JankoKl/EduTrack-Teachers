...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413307110895834376)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413307426206834376)
,p_plug_template_id=>wwv_flow_imp.id(25413307110895834376)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413307760771834376)
,p_plug_template_id=>wwv_flow_imp.id(25413307110895834376)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413308050371834376)
,p_plug_template_id=>wwv_flow_imp.id(25413307110895834376)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413308354574834376)
,p_plug_template_id=>wwv_flow_imp.id(25413307110895834376)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413308663087834377)
,p_plug_template_id=>wwv_flow_imp.id(25413307110895834376)
,p_name=>'Sub Regions'
