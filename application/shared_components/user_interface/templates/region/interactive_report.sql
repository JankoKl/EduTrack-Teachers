...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413302504677834374)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413302899201834374)
,p_plug_template_id=>wwv_flow_imp.id(25413302504677834374)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413303147918834374)
,p_plug_template_id=>wwv_flow_imp.id(25413302504677834374)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413303429430834374)
,p_plug_template_id=>wwv_flow_imp.id(25413302504677834374)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413303741072834374)
,p_plug_template_id=>wwv_flow_imp.id(25413302504677834374)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413304077917834374)
,p_plug_template_id=>wwv_flow_imp.id(25413302504677834374)
,p_name=>'Sub Regions'
