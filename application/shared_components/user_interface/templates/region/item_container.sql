...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413304676203834375)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413304940259834375)
,p_plug_template_id=>wwv_flow_imp.id(25413304676203834375)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413305278620834375)
,p_plug_template_id=>wwv_flow_imp.id(25413304676203834375)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413305503262834375)
,p_plug_template_id=>wwv_flow_imp.id(25413304676203834375)
,p_name=>'Button Start'
