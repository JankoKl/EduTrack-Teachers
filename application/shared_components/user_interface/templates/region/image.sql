...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413282509498834365)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413282898336834365)
,p_plug_template_id=>wwv_flow_imp.id(25413282509498834365)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413283199183834365)
,p_plug_template_id=>wwv_flow_imp.id(25413282509498834365)
,p_name=>'Sub Regions'
