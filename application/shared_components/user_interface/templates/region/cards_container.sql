...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413252757828834352)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413253079370834353)
,p_plug_template_id=>wwv_flow_imp.id(25413252757828834352)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413253307710834353)
,p_plug_template_id=>wwv_flow_imp.id(25413252757828834352)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413253618490834353)
,p_plug_template_id=>wwv_flow_imp.id(25413252757828834352)
,p_name=>'Sub Regions'
