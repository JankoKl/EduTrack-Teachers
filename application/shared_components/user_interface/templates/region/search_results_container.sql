...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413309664219834377)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413309952538834377)
,p_plug_template_id=>wwv_flow_imp.id(25413309664219834377)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413310276653834377)
,p_plug_template_id=>wwv_flow_imp.id(25413309664219834377)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413310589506834377)
,p_plug_template_id=>wwv_flow_imp.id(25413309664219834377)
,p_name=>'Sub Regions'
