...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25413279020928834364)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413279369077834364)
,p_plug_template_id=>wwv_flow_imp.id(25413279020928834364)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413279657902834364)
,p_plug_template_id=>wwv_flow_imp.id(25413279020928834364)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413279963387834364)
,p_plug_template_id=>wwv_flow_imp.id(25413279020928834364)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413280221164834364)
,p_plug_template_id=>wwv_flow_imp.id(25413279020928834364)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25413280508298834364)
,p_plug_template_id=>wwv_flow_imp.id(25413279020928834364)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
