prompt --application/shared_components/user_interface/lovs/nastavnici_ime
begin
--   Manifest
--     NASTAVNICI.IME
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(25732556768184058124)
,p_lov_name=>'NASTAVNICI.IME'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'NASTAVNICI'
,p_return_column_name=>'JMBG'
,p_display_column_name=>'IME'
,p_default_sort_column_name=>'IME'
,p_default_sort_direction=>'ASC'
,p_version_scn=>15554048965462
