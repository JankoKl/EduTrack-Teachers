prompt --application/shared_components/user_interface/lovs/prijave_vreme_prijave_1
begin
--   Manifest
--     PRIJAVE.VREME_PRIJAVE_1
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(25446610315679200898)
,p_lov_name=>'PRIJAVE.VREME_PRIJAVE_1'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'PRIJAVE'
,p_return_column_name=>'JMBG_NASTAVNIKA'
,p_display_column_name=>'VREME_PRIJAVE'
,p_default_sort_column_name=>'VREME_PRIJAVE'
,p_default_sort_direction=>'ASC'
,p_version_scn=>15553840100789
