...
@@application/shared_components/files/background_jpg.sql
...
@@application/shared_components/files/poz_jpg.sql
@@application/shared_components/files/dura_jpg.sql
@@application/shared_components/files/škola_jpg.sql
@@application/shared_components/files/strucno_usavrsavanje_jpg.sql
@@application/shared_components/files/skola_djura_jaksic_5_750x430_jpg.sql
@@application/shared_components/files/djura_soldatovic_jpg.sql
@@application/shared_components/files/v_velickovicnovember16_083_1_jpg.sql
@@application/shared_components/files/dura_jaksic_jpg.sql
@@application/shared_components/files/delfi_izabrana_dela_djura_jaksic_jpg.sql
...
@@application/shared_components/user_interface/lovs/nastavnici_ime.sql
@@application/shared_components/user_interface/lovs/nastavnici_ime_prezime.sql
@@application/shared_components/user_interface/lovs/predavaci_ime.sql
@@application/shared_components/user_interface/lovs/prijave_vreme_prijave.sql
@@application/shared_components/user_interface/lovs/prijave_vreme_prijave_1.sql
@@application/shared_components/user_interface/lovs/prijave_vreme_prijave_1_2.sql
@@application/shared_components/user_interface/lovs/seminari_lokacija.sql
@@application/shared_components/user_interface/lovs/struke_naziv.sql
@@application/shared_components/user_interface/lovs/tip_seminara_tip.sql
...
@@application/shared_components/security/authentications/potvrdaidentiteta.sql
